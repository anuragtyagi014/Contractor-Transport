...
$wp_customize->add_setting(
	'theme_options[featured_slider_status]',
	array(
...
$wp_customize->add_setting(
	'theme_options[featured_slider_image_info]',
	array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
...
$wp_customize->add_control(
	new Business_Club_Message_Control(
		$wp_customize,
		'theme_options[featured_slider_image_info]',
		array(
